...
## Repository
The repository contains the notebook which includes all our training and validation code and the models code. It also shows statistics of our model The repo also has the model which was trained for 30 epochs, the report and this readme file.
